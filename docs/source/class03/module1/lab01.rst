Lab 1 - Using AS3 to Create a HTTPS and HTTP applications
=========================================================

In this portion of the lab, you will be connect to your BIG-IP and create an application via AS3 using the extension for ``VS CODE``.
